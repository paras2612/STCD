...
def runTCDF(datafile):
    ...
    distances = np.loadtxt("/home/local/ASUAD/psheth5/Downloads/TCDF-master/test.txt")
    for c in columns:
        ...
        seed=seed, dilation_c=dilation_c, significance=significance, file=datafile, distances = distances)
